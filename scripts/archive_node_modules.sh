archive () {
    ...
    $1 -c --sort=name --owner=root:0 --group=root:0 --mtime='UTC 2019-01-01' --format gnu -f node_modules_backup/node_modules.tar node_modules &&
...
archive "tar" || (brew install gnu-tar && echo "Installed gtar" && archive "gtar") || echo "Failed to archive node_modules"
